...
import { COLOR_APPLICATOR_KEY, COPY_KEY, CUT_KEY, DELETE_FULL_ELEMENT_KEY, DELETE_KEY, DELETE_LAST_ELEMENT_KEY, DUPLICATE_KEY, ELLIPSE_KEY, ERASER_KEY, EYEDROPPER_KEY, FEATHER_KEY, GRID_KEY, LINE_KEY, NEW_DRAWING_KEY, OPEN_DRAWING_KEY, PAINTBRUSH_KEY, PASTE_KEY, PEN_KEY, PENCIL_KEY, POLYGON_KEY, RECTANGLE_KEY, REDO_KEY, SAVE_DRAWING_KEY, SELECT_ALL_KEY, SELECTION_KEY, UNDO_KEY } from 'src/app/data-structures/constants';
