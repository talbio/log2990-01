...
protected selectionDots: SelectionDot[];
  constructor(protected gridService: GridTogglerService) {
    this.selectionDots = [{x: 10, y: 10, color: 'white'}, {x: 60, y: 10, color: 'white'}, {x: 110, y: 10, color: 'white'},
    {x: 10, y: 35, color: 'white'}, {x: 60, y: 35, color: 'red'}, {x: 110, y: 35, color: 'white'}, {x: 10, y: 60, color: 'white'},
